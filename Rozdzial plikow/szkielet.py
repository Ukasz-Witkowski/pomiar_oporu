...
#<------tryb pomiar 2 próbek----
    ...
    #<------kanały temeperatura----
        ...
        self.P2_wybor_kanalow_t.setGeometry(QtCore.QRect(430, 355, 70, 22))
        font = QtGui.QFont()
        font.setPointSize(9)
...
#<------------tryb 4-punktowy----
    ...
    #<-----tempo i sledzenie temperatury-----------
        ...
        self.R4_temperatura.setGeometry(QtCore.QRect(1110, 470, 16, 18))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.R4_tempo.setGeometry(QtCore.QRect(1110, 558, 16, 18))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.R4_sledzenie_temp_wartosc.setGeometry(QtCore.QRect(1050, 611, 70, 22))
    ...
    #<----okna wykresów------
        ...
        self.R4_okno_wykresu_p.setGeometry(QtCore.QRect(40, 81, 660, 600))
    ...
    #<-----kanały próbka----------
        ...
        self.R4_wybor_kanalow_tekst_p.setGeometry(QtCore.QRect(200, 687, 91, 22))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.R4_wybor_kanalow_p.setGeometry(QtCore.QRect(300, 687, 50, 22))
        font = QtGui.QFont()
        font.setPointSize(9)
    ...
    #<------wybór osi------   
        ...
        self.R4_wybor_osix_tekst_p.setGeometry(QtCore.QRect(550, 687, 81, 22))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.R4_wybor_osix_p.setGeometry(QtCore.QRect(630, 687, 70, 22))
        font = QtGui.QFont()
        font.setPointSize(9)
    ...
    #<-------zakres-------
        ...
        self.R4_zakres_tekst.setGeometry(QtCore.QRect(360, 690, 91, 22))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.R4_zakres_p.setGeometry(QtCore.QRect(460, 690, 50, 20))
        font = QtGui.QFont()
        font.setPointSize(9)
    ...
    #<------skala log------
        ...
        self.R4_skala_log_p.setGeometry(QtCore.QRect(50, 687, 81, 22))
        font = QtGui.QFont()
        font.setPointSize(9)
    ...
    #<-----czestotliowsc--------
        ...
        self.R4_czestotliowsc_tekst.setGeometry(QtCore.QRect(750, 510, 201, 18))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setStyleStrategy(QtGui.QFont.PreferDefault)
        ...
        self.R4_czestotliowsc.setMinimum(1.0)
        self.R4_czestotliowsc.setMaximum(300.0)
        self.R4_czestotliowsc.setSingleStep(1.0)
        self.R4_czestotliowsc.setProperty("value", 3.0)
    ...
    #<------moc------------
        ...
        self.R4_moc_suwak.setGeometry(QtCore.QRect(750, 430, 321, 22))
        ...
        self.R4_moc.setGeometry(QtCore.QRect(1110, 400, 16, 18))
        font = QtGui.QFont()
        font.setPointSize(9)
...
#<------tryb ręczy--
    ...
    #<---------okno wykresu----
        ...
        self.CH20_okno_wykresu.setGeometry(QtCore.QRect(40, 100, 680, 610))
    ...
    #<-------czestotliwości----
        ...
        self.CH20_czestotliowsc_in_tekst.setGeometry(QtCore.QRect(730, 650, 180, 22))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setStyleStrategy(QtGui.QFont.PreferDefault)
        ...
        self.CH20_czestotliowsc_in.setGeometry(QtCore.QRect(910, 650, 62, 22))
        ...
        self.CH20_czestotliowsc_out_tekst.setGeometry(QtCore.QRect(730, 680, 171, 22))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setStyleStrategy(QtGui.QFont.PreferDefault)
        ...
        self.CH20_czestotliowsc_out.setGeometry(QtCore.QRect(910, 680, 62, 22))
        self.CH20_czestotliowsc_out.setMinimum(2.0)
        self.CH20_czestotliowsc_out.setMaximum(300.0)
        self.CH20_czestotliowsc_out.setSingleStep(1.0)
        self.CH20_czestotliowsc_out.setProperty("value", 3.0)
        self.CH20_czestotliowsc_out.setObjectName("CH20_czestotliowsc_out")
    #------------------------->

    #<-----start
        self.R4_start = QtWidgets.QPushButton(self.Tryb_CH20)
        self.R4_start.setGeometry(QtCore.QRect(1000, 650, 151, 50))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.R4_start.setFont(font)
        self.R4_start.setObjectName("R4_start")
...
#------->
    ...
    #---jeszcze cos--->
        ...
        self.P2_zakres_p1.setItemText(0, _translate("MainWindow", "1 R"))
        self.P2_zakres_p1.setItemText(1, _translate("MainWindow", "10 R"))
        self.P2_zakres_p1.setItemText(2, _translate("MainWindow", "100 R"))
        self.P2_zakres_p1.setItemText(3, _translate("MainWindow", "1 k"))
        self.P2_zakres_p1.setItemText(4, _translate("MainWindow", "10 k"))
        self.P2_zakres_p1.setItemText(5, _translate("MainWindow", "100 k"))
        self.P2_zakres_p1.setItemText(6, _translate("MainWindow", "1 M"))
        self.P2_zakres_p1.setItemText(7, _translate("MainWindow", "10 M"))
        self.P2_zakres_p1.setItemText(8, _translate("MainWindow", "100 M"))
        self.P2_zakres_tekst_p2.setText(_translate("MainWindow", "Zakres:"))
        self.P2_zakres_p2.setCurrentText(_translate("MainWindow", "100 M"))
        self.P2_zakres_p2.setItemText(0, _translate("MainWindow", "1 R"))
        self.P2_zakres_p2.setItemText(1, _translate("MainWindow", "10 R"))
        self.P2_zakres_p2.setItemText(2, _translate("MainWindow", "100 R"))
        self.P2_zakres_p2.setItemText(3, _translate("MainWindow", "1 k"))
        self.P2_zakres_p2.setItemText(4, _translate("MainWindow", "10 k"))
        self.P2_zakres_p2.setItemText(5, _translate("MainWindow", "100 k"))
        self.P2_zakres_p2.setItemText(6, _translate("MainWindow", "1 M"))
        self.P2_zakres_p2.setItemText(7, _translate("MainWindow", "10 M"))
        self.P2_zakres_p2.setItemText(8, _translate("MainWindow", "100 M"))
    #--------->

        self.R4_temperatura.setText(_translate("MainWindow", "0"))
        self.R4_wybor_osix_p.setItemText(0, _translate("MainWindow", "T [K]"))
        self.R4_wybor_osix_p.setItemText(1, _translate("MainWindow", "t [s]"))
        self.R4_tempo.setText(_translate("MainWindow", "0"))
        self.R4_wybor_kanalow_t.setCurrentText(_translate("MainWindow", "20"))
        self.R4_wybor_kanalow_t.setItemText(0, _translate("MainWindow", "20"))
        self.R4_wybor_kanalow_t.setItemText(1, _translate("MainWindow", "Kanał 2"))
        self.R4_wybor_kanalow_t.setItemText(2, _translate("MainWindow", "Kanał 3"))
        self.R4_wybor_kanalow_t.setItemText(3, _translate("MainWindow", "Kanał 4"))
        self.R4_wybor_kanalow_t.setItemText(4, _translate("MainWindow", "Kanał 5"))
        self.R4_wybor_kanalow_t.setItemText(5, _translate("MainWindow", "Kanał 6"))
        self.R4_wybor_kanalow_t.setItemText(6, _translate("MainWindow", "Kanał 7"))
        self.R4_wybor_kanalow_t.setItemText(7, _translate("MainWindow", "Kanał 8"))
        self.R4_wybor_kanalow_t.setItemText(8, _translate("MainWindow", "Kanał 9"))
        self.R4_wybor_kanalow_t.setItemText(9, _translate("MainWindow", "Kanał 10"))
        self.R4_wybor_kanalow_t.setItemText(10, _translate("MainWindow", "Kanał 11"))
        self.R4_wybor_kanalow_t.setItemText(11, _translate("MainWindow", "Kanał 12"))
        self.R4_wybor_kanalow_t.setItemText(12, _translate("MainWindow", "Kanał 13"))
        self.R4_wybor_kanalow_t.setItemText(13, _translate("MainWindow", "Kanał 14"))
        self.R4_wybor_kanalow_t.setItemText(14, _translate("MainWindow", "Kanał 15"))
        self.R4_wybor_kanalow_t.setItemText(15, _translate("MainWindow", "Kanał 16"))
        self.R4_wybor_kanalow_t.setItemText(16, _translate("MainWindow", "Kanał 17"))
        self.R4_wybor_kanalow_t.setItemText(17, _translate("MainWindow", "Kanał 18"))
        self.R4_wybor_kanalow_t.setItemText(18, _translate("MainWindow", "Kanał 19"))
        self.R4_wybor_kanalow_t.setItemText(19, _translate("MainWindow", "Kanał 20"))
        self.R4_wybor_kanalow_tekst_p.setText(_translate("MainWindow", "Wybór kanału"))
        self.R4_zakres_p.setCurrentText(_translate("MainWindow", "1 R"))
        self.R4_zakres_p.setItemText(0, _translate("MainWindow", "1 R"))
        self.R4_zakres_p.setItemText(1, _translate("MainWindow", "10 R"))
        self.R4_zakres_p.setItemText(2, _translate("MainWindow", "100 R"))
        self.R4_zakres_p.setItemText(3, _translate("MainWindow", "1 k"))
        self.R4_zakres_p.setItemText(4, _translate("MainWindow", "10 k"))
        self.R4_zakres_p.setItemText(5, _translate("MainWindow", "100 k"))
        self.R4_zakres_p.setItemText(6, _translate("MainWindow", "1 M"))
        self.R4_zakres_p.setItemText(7, _translate("MainWindow", "10 M"))
        self.R4_zakres_p.setItemText(8, _translate("MainWindow", "100 M"))
        ...
        self.R4_wybor_kanalow_p.setCurrentText(_translate("MainWindow", "20"))
        self.R4_wybor_kanalow_p.setItemText(0, _translate("MainWindow", "20"))
        self.R4_wybor_kanalow_p.setItemText(1, _translate("MainWindow", "Kanał 2"))
        self.R4_wybor_kanalow_p.setItemText(2, _translate("MainWindow", "Kanał 3"))
        self.R4_wybor_kanalow_p.setItemText(3, _translate("MainWindow", "Kanał 4"))
        self.R4_wybor_kanalow_p.setItemText(4, _translate("MainWindow", "Kanał 5"))
        self.R4_wybor_kanalow_p.setItemText(5, _translate("MainWindow", "Kanał 6"))
        self.R4_wybor_kanalow_p.setItemText(6, _translate("MainWindow", "Kanał 7"))
        self.R4_wybor_kanalow_p.setItemText(7, _translate("MainWindow", "Kanał 8"))
        self.R4_wybor_kanalow_p.setItemText(8, _translate("MainWindow", "Kanał 9"))
        self.R4_wybor_kanalow_p.setItemText(9, _translate("MainWindow", "Kanał 10"))
        self.R4_wybor_kanalow_p.setItemText(10, _translate("MainWindow", "Kanał 11"))
        self.R4_wybor_kanalow_p.setItemText(11, _translate("MainWindow", "Kanał 12"))
        self.R4_wybor_kanalow_p.setItemText(12, _translate("MainWindow", "Kanał 13"))
        self.R4_wybor_kanalow_p.setItemText(13, _translate("MainWindow", "Kanał 14"))
        self.R4_wybor_kanalow_p.setItemText(14, _translate("MainWindow", "Kanał 15"))
        self.R4_wybor_kanalow_p.setItemText(15, _translate("MainWindow", "Kanał 16"))
        self.R4_wybor_kanalow_p.setItemText(16, _translate("MainWindow", "Kanał 17"))
        self.R4_wybor_kanalow_p.setItemText(17, _translate("MainWindow", "Kanał 18"))
        self.R4_wybor_kanalow_p.setItemText(18, _translate("MainWindow", "Kanał 19"))
        self.R4_wybor_kanalow_p.setItemText(19, _translate("MainWindow", "Kanał 20"))
